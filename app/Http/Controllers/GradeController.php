	    ...
	    if ($request->ajax()) 
	    {
	        ...
	        $formattedData = $data->map(function($row) 
	        {
	            return [
	                ...
	                'action' => '<a href="' . route('view_grade', $row->GradeID) .'"><i class="fa fa-eye button_orange" aria-hidden="true"></i></a><a href="' . route('edit_grade', $row->GradeID) .'"><i class="fa fa-pencil-square-o button_orange" aria-hidden="true"></i></a><a onclick="delete_grade_modal(\'' . $row->GradeID . '\')"><i class="fa fa-trash button_orange" aria-hidden="true"></i></a>',
