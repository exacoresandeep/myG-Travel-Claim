	    ...
	    { 
			...
			$formattedData = $data->map(function($row) {
				...
				return [
	                ...
	                'Status' => $row->Status, 
					'action' => '<a href="' . route('edit_role', $row->id) .'"><i class="fa fa-pencil-square-o button_orange" aria-hidden="true"></i></a> <a onclick="delete_role_modal(' . $row->id . ')"><i class="fa fa-trash button_orange" aria-hidden="true"></i></a>',
